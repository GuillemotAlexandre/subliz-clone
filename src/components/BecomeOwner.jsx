  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
      ...
      <div className="lg:w-3/5 grid grid-cols-1 md:grid-cols-2 gap-6">
        {cards.map((card, idx) => (
          <div key={idx} className="bg-slate-50 p-8 rounded-xl border border-transparent hover:border-gray-200 transition-all">
            <div className="text-[#5D5FEF] mb-6 text-2xl">{card.icon}</div>
